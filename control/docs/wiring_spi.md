...
![SPI Mode 0 Timing Diagram](spi_timing.png)

**Example: Channel 0 → 1500 µs (neutral)**

| Byte | Hex | Binary | Content |
|------|-----|--------|---------|
| 0 | `0x00` | `00000000` | Channel 0 |
| 1 | `0x05` | `00000101` | 1500 >> 8 (high byte) |
| 2 | `0xDC` | `11011100` | 1500 & 0xFF (low byte) |
